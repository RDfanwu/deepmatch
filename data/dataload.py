...
class ModelNet40(Dataset):
    ...
    def __getitem__(self, item):
        ...
        pointcloud2 = rotation.apply(pointcloud1.T).T + np.expand_dims(translation, axis=1)
        ...
        return pointcloud1.astype('float32'), pointcloud2.astype('float32'), R.astype('float32'), \
               translation.astype('float32'), euler.astype('float32')
